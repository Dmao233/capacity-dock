...
enum CodexSubscriptionService {
    ...
    private static let usageBlockedUntilKey = "CapacityDock.codex.usage.blockedUntil"
    ...
    private static func fetchWithToken(_ token: String, allowOne401Recovery: Bool) async throws -> CodexUsage {
        ...
        request.setValue("CapacityDock", forHTTPHeaderField: "User-Agent")
        ...
        case 200:
            ...
            do {
                ...
                NSLog("CapacityDock: codex usage decode failed: %@", String(describing: error))
